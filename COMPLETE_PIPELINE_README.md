...
- PnLCalib field lines (black, thin) - complete projection with arcs using **raw calibration** for accuracy
- Camera position (x, y, z) in meters (top-left, black text) - from **smoothed calibration**
- Camera rotation (roll, pitch, yaw) in degrees (top-left, black text) - from **smoothed calibration**
...
**Video Output**: See `results/V2_1/stage5_finalization/final_video.mp4` for the complete annotated video (7.1 MB, 30fps)
